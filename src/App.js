            ...
            <div className="row gy-5">
              <div className="col-lg-5">
                <div className="section-heading">
                  ...
                  <h2>My experience</h2>
                  <p>
                    Hello there! My name is Muhammad Kashif. I am a web designer
              ...
              <div className="col-lg-7 ps-xl-5">
                <ul className="resume-box">
                  ...
                  <li>
                    <div className="r-meta">
                      <span>-2015 - 2017</span>
                      <label>-Jr. UI/UX Designer</label>
                    </div>
                    <h5>Web Design and Developer</h5>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="col-lg-6">
                <div className="work-box">
                  ...
                  <div className="work-text">
                    <h6>UX case study</h6>
                    <h4>Bally Website Research</h4>
                    <div className="btn-bar">
                      <a
                        className="gallery-link"
                        href="assets/img/services-1.jpg"
                      >
                ...
                <div className="work-box">
                  ...
                  <div className="work-text">
                    ...
                    <div className="btn-bar">
                      <a
                        className="gallery-link"
                        href="assets/img/services-2.jpg"
                      >
                        <i className="bi-arrow-up-right" />
                      </a>
                    </div>
                ...
                <div className="work-box">
                  ...
                  <div className="work-text">
                    ...
                    <div className="btn-bar">
                      <a
                        className="gallery-link"
                        href="assets/img/services-3.jpg"
                      >
                        <i className="bi-arrow-up-right" />
                      </a>
                    </div>
